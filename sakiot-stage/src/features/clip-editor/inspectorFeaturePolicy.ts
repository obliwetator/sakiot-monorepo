...
export const INSPECTOR_FEATURE_POLICIES = {
	...
	distortion: { multiSelection: "handled" },
	delay: { multiSelection: "handled" },
	compressor: { multiSelection: "handled" },
	chorus: { multiSelection: "handled" },
	reverb: { multiSelection: "handled" },
	tail: { multiSelection: "handled" },
	split: {},
